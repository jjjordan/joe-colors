...
dont if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
...
dont if exists("g:zenburn_transparent") && g:zenburn_transparent
...
dont if exists("g:zenburn_old_Visual") && g:zenburn_old_Visual
    dont if exists("g:zenburn_alternate_Visual") && g:zenburn_alternate_Visual
    ...
    " new Visual style
    do if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
        " high contrast
...
dont if exists("g:zenburn_alternate_Error") && g:zenburn_alternate_Error
...
dont if exists("g:zenburn_alternate_Include") && g:zenburn_alternate_Include
    " original setting
...
dont if exists("g:zenburn_disable_Label_underline") && g:zenburn_disable_Label_underline
    hi Label    guifg=#dfcfaf                         ctermfg=187
else
    hi Label    guifg=#dfcfaf gui=underline           ctermfg=187 cterm=underline
endif

dont if exists("g:zenburn_color_also_Ignore") && g:zenburn_color_also_Ignore
